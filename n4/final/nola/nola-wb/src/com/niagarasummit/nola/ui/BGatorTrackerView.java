...
/*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  ...
  {
    BGator[] list = tracker.getChildren(BGator.class);
    for (BGator aList : list)
    {
      model.addRow(new Object[] { Clock.time(), aList.getName(), aList.get(BGator.length), aList.get(BGator.weight) });
    }
  }
...
////////////////////////////////////////////////////////////////
  ...
  public CommandArtifact doRemove()
  {
    ...
    {
      tracker.remove(model.getValueAt(selRow, GATOR_NAME_ROW_INDEX).toString());
    }
    model.updateTable();
    return null;
  }
